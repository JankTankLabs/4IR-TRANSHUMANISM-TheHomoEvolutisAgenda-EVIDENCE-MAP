...
- Executive Brief, Impact Matrix, lens presets, High-Convergence Pathways, Legacy Roots/Family Lineages with a presidential family-tree/royal-ancestry claim layer, Investigation Console, inline discovery drawer, Pattern Narratives, Quote Vault, Connection Constellation, bookmarks, compare tray, and random-thread discovery make navigation more guided without hijacking the global search.
